...
<br>
Step 6: Now to run the application, Enter "nodemon server.js" or "npm run start" and "node server.js" if you don't have npm nodemon.
<br>
...
Heroku link:
[Heroku Link](https://tech-talk-blogger-726329b88ecf.herokuapp.com/)
